...
import com.creditoservice.dto.UsuarioResponseDTO;
import com.creditoservice.exception.EmailIndisponivelException;
import com.creditoservice.exception.InvalidParameterException;
import com.creditoservice.exception.NotFoundException;
import com.creditoservice.repository.UsuarioRepository;
